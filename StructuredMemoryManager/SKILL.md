...
**返回值：** `list[dict]`，每项包含 `file_path, entry_id, anchor, content_snippet, score, priority, tags`
...
| `action` | string | 是 | - | 操作类型：confirm / extend / upgrade / downgrade |
